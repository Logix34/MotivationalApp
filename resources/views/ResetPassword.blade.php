                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form role="form" class="user needs-validation" method="POST" action="{{route('submit_reset')}}" autocomplete="off">
                                    @csrf
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user" id="code" name="code"  value="" placeholder="Enter OTP">
                                        @error('code')
